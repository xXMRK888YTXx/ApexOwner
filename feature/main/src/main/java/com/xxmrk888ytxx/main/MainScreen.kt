    ...
    Card(
        ...
        Column(
            ...
            Row(
                ...
                Text(
                    text = if (isGranted) stringResource(R.string.device_owner_active) else stringResource(R.string.action_required),
                    style = MaterialTheme.typography.titleMedium,
